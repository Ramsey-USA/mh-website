...
| Home hero video controller     | [apps/website/src/components/home/HeroSectionClient.tsx](/workspaces/mh-website/apps/website/src/components/home/HeroSectionClient.tsx)                       | Media element refs, `matchMedia`, `navigator.connection`, `IntersectionObserver`, and playback controls. | Remains client; active in production for manifest-backed home hero playback with static poster fallback |
