...
**Category:** Development - Chatbot System  
...
- [🤖 Chatbot First Strategy](./chatbot-first-strategy.md)
...
if (userProfile.isVeteran) {
  response +=
    "\n\n**VETERAN DISCOUNT:** Don't forget your Combat Veteran Discount at the Ready!";
}
```
...
**Documentation:** See `/docs/development/chatbot-integration.md` for full system documentation
