...
public/
�"o�"?�"? images/
�",   �"o�"?�"? blog/                  # Blog post hero/thumbnail images
�",   �"o�"?�"? bbb/                   # BBB accreditation seals (keep)
�",   �"o�"?�"? compliance/            # Prevailing-wage, bonding, safety, veteran (keep)
�",   �",   �""�"?�"? mvr-records/       # �+? NEW: redacted annual driver qualification logs (MVR)
�",   �"o�"?�"? credentials/           # Chamber & association logos (keep)
�",   �"o�"?�"? culture/               # Job-site life / team culture shots (keep)
�",   �",
�",   �"o�"?�"? logo/                  # Brand marks (keep)
�",   �",
�",   �"o�"?�"? news/                  # News article thumbnails
�",   �"o�"?�"? og/                    # Open-Graph images �?" one per page (rename from og-default.*)
�",   �",   �"o�"?�"? og-home.webp       # 1200 A- 630
�",   �",   �"o�"?�"? og-testimonials.webp
�",   �",   �"o�"?�"? og-projects.webp
�",   �",   �""�"?�"? ...one per route
�",   �",
�",   �"o�"?�"? patterns/              # SVG/CSS pattern overlays (keep)
�",   �"o�"?�"? projects/              # Project portfolio photos (keep)
�",   �",   �""�"?�"? [slug]/            # �+? NEW: one subfolder per project
�",   �",       �"o�"?�"? hero.webp      # 1200 A- 684 �?" main card image
�",   �",       �"o�"?�"? before-01.webp # Before photos
�",   �",       �"o�"?�"? after-01.webp  # After photos
�",   �",       �""�"?�"? detail-01.webp # Close-up / finish detail
�",   �",
�",   �"o�"?�"? qr-codes/              # QR codes (keep)
�",   �",
�",   �"o�"?�"? safety/                # Safety program section images (keep)
�",   �",
�",   �"o�"?�"? social/                # �+? NEW: pre-sized graphics for social posts
�",   �",   �"o�"?�"? templates/         # Canva/Figma export base images
�",   �",   �"o�"?�"? testimonials/      # Auto-generated testimonial share cards
�",   �",   �",   �""�"?�"? [id].webp      # e.g. client-001.webp  (1080 A- 1080)
�",   �",   �""�"?�"? announcements/     # Project completion, milestone posts
�",   �",
�",   �"o�"?�"? team/                  # Team headshots (keep)
�",   �",
�",   �"o�"?�"? testimonials/          # �+? NEW: client/site photos tied to reviews
�",   �",   �"o�"?�"? client-001.webp    # Photo at project site (matches testimonial id)
�",   �",   �"o�"?�"? client-002.webp
�",   �",   �""�"?�"? ...
�",   �",
�",   �"o�"?�"? textures/              # Background textures (keep)
�",   �"o�"?�"? values/                # Values section images (keep)
�",   �""�"?�"? vendors/               # Vendor/ally partner logos (keep)
�",
�"o�"?�"? videos/
�",   �"o�"?�"? testimonials/          # �+? NEW: short client video testimonials
�",   �",   �""�"?�"? client-001.mp4     # matches testimonial id
�",   �"o�"?�"? projects/              # �+? NEW: project walkthrough / time-lapse
�",   �",   �""�"?�"? [slug].mp4
�",   �"o�"?�"? culture/               # �+? NEW: recruitment / culture reels
�",   �""�"?�"? mh_veterans_day_vid.mp4  # existing (keep)
�",
�"o�"?�"? documents/
�",   �""�"?�"? subcontractors/        # �+? NEW: Subcontractor Matrix + verified COI/AIE templates
�",       �"o�"?�"? subcontractor-matrix.xlsx   # Master list with insurance expiration dates
�",       �"o�"?�"? coi-template.pdf            # Certificate of Insurance template
...
1. Drop the new `.webp` in the correct folder (see A1).
...
| OG / social preview (landscape) | 1200 px (1200 A- 630)         | 90 WebP |
...
Each page should have its own OG image (1200 A- 630 px WebP) stored in
...
2. Collect:
   �"o�"?�"? Client portrait or job-site photo (JPG/PNG, min 800A-800 px)
   �"o�"?�"? Quote (verbatim, approved by client)
   �""�"?�"? Project photo (optional, from projects/ folder)

3. Drop source photos into:
   �"o�"?�"? public/images/testimonials/[id].jpg     �+? client photo
...
6. Create a social card (1080A-1080 px):
   �"o�"?�"? Use the Canva template in /documents/brands/
   �"o�"?�"? Export as PNG �+' drop in public/images/social/testimonials/client-023.png
...
8. Trigger distribution (see A7 and A8).
```
...
2. Superintendent provides written safety verification before the image is
   ...
   �"o�"?�"? All workers in frame gave verbal consent to be photographed
   �"o�"?�"? 100% PPE compliance verified at time of capture
...
5. Create a LinkedIn-optimized post card (1200 A- 627 px) using the
...
6. Before posting to LinkedIn:
   �"o�"?�"? Attach the Superintendent's written safety verification to the
...
Webhook trigger (POST from site)
  �",
  �"o�"?�-� Facebook Page post (Graph API node)
  �",     caption: "[quote]" �?" [clientName], [location] #MHConstruction #[ProjectType]
  �",     image: imageUrl
  �",
  �"o�"?�-� Instagram Business post (HTTP Request node �+' Graph API)
  �",     same caption + image
  �",
  �"o�"?�-� LinkedIn Company page post (LinkedIn node)
...
Schedule trigger (runs daily at 08:00 PT)
  �",
  �"o�"?�-� Query Subcontractor Matrix or HR records
...
Schedule trigger (runs daily at 07:00 PT)
  �",
  �"o�"?�-� Read Subcontractor Matrix
  �",     (HTTP Request �+' Google Sheets API or internal DB)
  �",     Filter: coi_expiration_date BETWEEN TODAY AND TODAY + 15 days
  �",
  �"o�"?�-� For each flagged subcontractor:
  �",   �"o�"?�-� Update Matrix status column �+' "�s� COI EXPIRING SOON"
  �",   �"o�"?�-� Send Email alert to operations@mhc-gc.com
  ...
  �",         Update status �+' "dY"' COI EXPIRED �?" DO NOT USE"
...
Webhook trigger
  �",
  �"o�"?�-� Query D1 (HTTP Request �+' Cloudflare D1 REST API)
  �",     SELECT email, name FROM newsletter_subscribers WHERE unsubscribed = 0
  �",
  �"o�"?�-� Loop over subscribers (Split In Batches node, 50/batch)
  �",
  �""�"?�-� Resend �?" Send Email (HTTP node)
        to: subscriber.email
        from: hello@mhc-gc.com
        subject: "See What Our Clients Are Saying dY?-�,?"
        html: testimonial email template (see A8c)
```
...
| �?�        | all others      | `og-default.webp` (existing fallback) | �o" in place |

**OG image specs:** 1200 A- 630 px A� WebP A� �% 200 KB A� include company logo
in corner A� overlaid page title text.
...
- [ ] Dropped into correct folder per A1 with correct filename per A2
...
- [ ] `alt` text written following the formula in A5a
- [ ] `sizes` attribute set correctly per A5d
...
- [ ] Schema.org structured data updated if applicable (A5b)
- [ ] OG image updated for the affected page (A9)

### Videos

- [ ] `.mp4` and `.webm` versions encoded per A10b via `optimize:videos`
- [ ] Poster `poster-{name}.jpg` exists in the same folder
- [ ] `OptimizedVideo` component used (not raw `<video>`)
- [ ] `VideoObject` schema added to page (A10d)
...
- [ ] Safety Snapshot: written Superintendent verification obtained before LinkedIn distribution (A6c)
...
- [ ] n8n "Testimonial Social Post" workflow triggered (A7)
- [ ] Email blast sent if `emailBlast: true` (A8)
...
### Phase 1 �?" Foundation �o. COMPLETE

1. �o. Create the new folders: `public/images/testimonials/`, `public/images/social/testimonials/`, `public/images/og/`, `public/videos/testimonials/`, `public/videos/projects/`, `public/videos/culture/`
2. �o. Extend the `Testimonial` interface in `testimonials.ts` with the new fields (`projectPhoto`, `videoUrl`, `socialCard`, `publishedToSocial`, `publishedAt`, `platforms`) (A6a)
3. �o. `TestimonialCard` updated to render real photo when `image` is set (falls back to initials avatar)
4. �o. `/api/testimonials/publish` API route built �?" admin-protected, fires n8n webhook (A7a)
5. �o. `n8n-webhook.ts` extended with `"testimonial-publish"` form type
6. �o. `review-schema.ts` extended with `image` field �?" testimonials page wires photo URL into schema
7. �o. `optimize-images.js` updated with `testimonials`, `social`, and `og` category size limits
...
- Safety Snapshot gallery section (A6c) as a live social proof feed
...
3. �~? Activate n8n MVR Review alert workflow (A7d) and test with one employee record
4. �~? Activate n8n COI Expiration flag workflow (A7d) and verify against current Subcontractor Matrix
...
1. �~? Design and export OG images for the 8 priority pages (A9) at 1200A-630 px
...
1. �o. `/api/testimonials/publish` route built
2. �~? Configure `N8N_TESTIMONIAL_WEBHOOK_URL` environment variable in Cloudflare Workers secrets
3. �~? Build n8n "Testimonial Social Post" workflow (A7b) �?" connect Facebook, Instagram, LinkedIn, Twitter nodes
4. �~? Build n8n "Testimonial Email Blast" sub-workflow (A8b)
5. �~? Create `testimonial-blast` email template at `src/lib/email/templates/testimonial-blast.tsx` (A8c)
6. �~? Test with one platform + one subscriber before full launch

### Phase 6 �?" Video

1. �~? Encode `mh_veterans_day_vid` poster image using ffmpeg (A10b), add as `/videos/mh_veterans_day_vid-poster.webp`
