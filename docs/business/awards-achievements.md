...
**Award:** Top Most Improved EMR

**Achievement:**

- 25% reduction in EMR from 2024
...
**Award:** Top EMR and 'As Low as You Can Go Award' at .6

**Achievement:**

- Experience Modification Rate (EMR) of .6
- At least 3 continuous years without time loss or impairment injury
...
- **Above 1.0 = Worse than average** (higher claims/safety concerns)

### MH Construction's EMR Performance

Our consistent EMR of **.6** represents:

- **40% better than industry average**
- Significantly lower workers' compensation costs
- Demonstrated commitment to worker safety
- Competitive advantage in bidding and insurance costs
- Trust indicator for clients and project partners

### L&I Claims Free Discount Program

Participation in Washington State's Labor & Industries Claims Free Discount Program requires:

- Zero time-loss injuries
- Zero impairment injuries
- Consistent safety protocol implementation
- Ongoing safety training and compliance

Our multi-year streak demonstrates sustained excellence, not just periodic compliance.
...
- Reserved for companies with outstanding safety performance
...
## 🎖️ Veteran Business Certifications

### Certified Veteran-Owned Small Business (VOSB)

**Certification:** Department of Veterans Affairs
**Status:** Active since January 2025
**Owner:** Jeremy Thamert, U.S. Army Veteran

**Significance:**

- Veteran-owned business certification
- Federal contracting eligibility
- Veteran entrepreneurship excellence recognition
- Commitment to military values in civilian business
...
3. **Training & Certification**
   - OSHA 30 certification for leadership
   - OSHA 10 for all team members
   - Specialized equipment training
   - CPR and first aid certification

4. **Military Precision Approach**
   - Systematic safety procedures
   - Clear chain of command
   - Detailed documentation
   - After-action safety reviews

### Safety Statistics

- **2019-2021:** 3+ consecutive years without time-loss injury
- **EMR Performance:** Consistently .6 (40% better than industry average)
- **2025 Improvement:** 25% EMR reduction from previous year
- **OSHA VPP:** Star designation holder

---

## 📈 Impact on Client Projects

Our award-winning safety record provides clients with:
...
- Safety-first culture drives quality
...
- Lower insurance premiums passed to clients
- Reduced contingency requirements
- Fewer change orders from incidents
...
- [**Core Values**](./core-values.md) - Four-value professional foundation
- [**Team Roster**](./team-roster.md) - Meet our award-winning team
- [**Services Overview**](./services.md) - Complete service offerings

---

**Document Authority:** MH Construction Business Documentation Team
**Next Review:** Annually or upon receiving new awards
**Maintained By:** Executive Leadership Team
