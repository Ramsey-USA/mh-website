...
**Audience**: Leadership, Marketing, Stakeholders

Brand identity, company values, messaging guidelines, and strategic positioning.
...
Visual design standards, typography, colors, icons, and component specifications.
...
Developer quick references, code patterns, and implementation checklists.
...
1. Start with **[Brand Overview](./strategy/brand-overview.md)** - Understand brand identity
2. Review **[Color System](./standards/color-system.md)** - Color palette
3. Study **[Component Standards](./standards/component-standards.md)** - UI specifications
...
**Questions?** Contact the development team or refer to the comprehensive
**[Consistency Guide](../development/consistency-guide.md)** for detailed implementation information.
