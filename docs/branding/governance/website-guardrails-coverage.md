...
| Navigation/Overlay         | `docs/branding/standards/unified-component-standards.md#navigation-overlay-and-header-action-visual-contract-canonical`      | `docs/archive/2026-08/homepage.md`                            | `docs/development/standards/page-compliance-checklist.md` |
...
25. `/qr-codes` (retired permanent redirect to `/resources`)
26. `/resources`
