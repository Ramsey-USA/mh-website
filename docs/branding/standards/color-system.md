...
Fast implementation tables and copy-ready examples now live in:

- [Color Quick Reference](./color-quick-reference.md)

Use this standards file as the canonical policy source for brand color rules,
exceptions, accessibility requirements, gradients, and token governance.
