...
| ------------------------ | --------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| **Subtitle**             | "Join a Team That Invests in You • Building for the Client, NOT the Dollar" | "Join a Team That Invests in You • Where Your Growth Is Our Mission"         | Group 5 recruitment slogan more appropriate than Group 1 business slogan |
...
| **Philosophy**            | "Building for the Client, NOT the Dollar"                                                      | "Your Growth Is Our Mission"                                                                                                                                                                                                    | Group 5 recruitment slogan instead of Group 1 business slogan |
...
| **Tagline**        | "Building for the Client, NOT the Dollar" | "Where Talent Meets OPPORTUNITY"   | Group 5 recruitment focus instead of Group 1 business slogan |
