...
When creating a new page, develop a unique hero tagline following these principles:

#### Length

- **Target:** 3-7 words
- **Why:** Short enough to be memorable, long enough to convey meaning
- **Examples:** 4-5 words is optimal sweet spot

#### Relevance

- Must directly relate to the page's primary purpose
- Should communicate the page's unique value
- Cannot be generic enough to work on any page

#### Brand Alignment

- Reflects MH Construction values (integrity, partnership, quality)
- Maintains professional, confident tone
- Appropriate for construction industry context

#### Clarity

- Immediately understandable without explanation
- No jargon or insider language
- Works for both industry professionals and general public

#### Uniqueness

- Different from all existing page taglines
- Memorable and distinctive
- Cannot be confused with other pages
...
- Length (3-7 words?)
- Relevance (page-specific?)
- Brand alignment (matches tone?)
...
Before finalizing any hero tagline:

- [ ] Is it 3-7 words in length?
- [ ] Does it reflect THIS specific page's purpose (not generic)?
...
- [ ] Would visitors remember it after leaving the page?
- [ ] Does it avoid overusing "THE ROI IS THE RELATIONSHIP"?
- [ ] Have you tested it with at least 3 people?
- [ ] Does it pass the "could this work on another page?" test (should be NO)?
- [ ] Is it documented in this guide with strategy explanation?

---

## 🚫 Common Mistakes to Avoid

### DON'T: Use Generic Taglines

**Bad:** "Quality Construction Services"
**Why:** Could apply to any construction company or page

**Good:** "Mission-Ready, Compliance-Driven" (Government page)
**Why:** Specific to federal contracting expertise

### DON'T: Repeat "THE ROI IS THE RELATIONSHIP"

**Bad:** Using this phrase in every hero section
**Why:** Creates tagline fatigue and reduces impact

**Good:** Use it strategically in body content where relationships are discussed
**Why:** Maintains power through selective use

### DON'T: Make it Too Long

**Bad:** "Experience the Difference of Working With a Veteran-Owned Team"
**Why:** Too long to be memorable, feels like a sentence not a tagline

**Good:** "Experience You Can Trust"
**Why:** Concise, memorable, impactful

### DON'T: Use Industry Jargon

**Bad:** "Optimized Construction Management Protocols"
**Why:** Jargony, unclear to general audiences

**Good:** "Your project deserves expert oversight"
**Why:** Clear benefit, accessible language

### DON'T: Be Vague

**Bad:** "Building Better Together"
**Why:** Generic, unclear what "better" means

**Good:** "Building Success Together" (Trade Partners page)
**Why:** Clear focus on mutual business success in B2B context
...
```markdown
At MH Construction, THE ROI IS THE RELATIONSHIP. We measure success not
just by profit margins, but by the lasting partnerships we build with every
client. Your success becomes our success.
```

**Testimonials & Reviews:**

```markdown
"Working with MH Construction proved that THE ROI IS THE RELATIONSHIP.
They were invested in our success just as much as we were."
```

**About/Values Sections:**

```markdown
Our Philosophy: THE ROI IS THE RELATIONSHIP

We invest in long-term partnerships that extend well beyond project completion.
```

**Team Bios:**

```markdown
Mike Holstein embodies our "THE ROI IS THE RELATIONSHIP" philosophy,
maintaining client relationships that span decades.
```

**Partnership Pages:**

```markdown
For our trade partners, THE ROI IS THE RELATIONSHIP means fair pricing,
timely payment, and consistent work opportunities.
```
...
Don't repeat it in every hero—that's what this strategy solves.

**Generic Filler:**

Don't use it as generic text to fill space without context.

**Sales Pressure:**

Don't use it as a high-pressure sales tactic.
...
Track these metrics to evaluate tagline effectiveness:

**Engagement Metrics:**

- Time on page (expect increase with engaging taglines)
- Scroll depth (clear messaging encourages exploration)
- Bounce rate (expect decrease with relevant taglines)
...
- Brand recall surveys (do visitors remember taglines?)
- Message association (do they connect taglines to correct pages?)
- Overall brand perception scores

**SEO Metrics:**

- Page-specific keyword rankings
...
1. Run hero tagline for 30-90 days
2. Collect baseline metrics
3. Test alternative tagline
4. Compare performance
5. Implement winner

**User Feedback:**

- Exit surveys: "What was this page about?"
- Recall tests: "What do you remember from the [page name] page?"
- Clarity surveys: "Was the page's purpose immediately clear?"
...
- Documented strategy for unique hero taglines
- Catalogued all 12 current page taglines
- Provided creation guidelines and checklists
- Defined appropriate/inappropriate uses of "THE ROI IS THE RELATIONSHIP"

**Impact:**

- Replaced repetitive ROI messaging with unique taglines
- Improved page differentiation and message retention
- Maintained brand consistency while adding contextual relevance
...
**For Developers:**
See [Hero Section Standards](../standards/hero-section-standards.md) for
implementation details.

**For Content Writers:**
Refer to creation guidelines and testing checklist in this document.

**For Marketing Team:**
Review measuring success section for performance tracking.

**For Strategy Questions:**
Contact brand team or refer to [Messaging Guidelines](./messaging.md).
...
**Remember:** "THE ROI IS THE RELATIONSHIP" is still a powerful brand message—we're
just using it more strategically by not putting it in every single hero section.
