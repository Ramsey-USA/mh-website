...
**Tech Stack:** Next.js 16.2.10 + React 19.2.7 + Tailwind CSS 4.3.2 + TypeScript 6.0.3 on Cloudflare Workers via `@opennextjs/cloudflare` 1.20.1 (Wrangler 4.110.0) — high-performance, mobile-responsive, tactical professional tone.
...
│  ├── Runtime: @opennextjs/cloudflare 1.20.1 (Next.js 16.2.10)               │
...
Recommended additions and implementation checklists have been split into:

- [Services Integration Roadmap](./services-integration-roadmap.md)

Use that roadmap for rollout planning, priorities, and operations ownership.
Keep this guide focused on currently implemented services and integration wiring.
