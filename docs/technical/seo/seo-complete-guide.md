...
All lead-path pages follow the **Universal Page Flow Standard**
(Discover → Trust → Proof → Action).

For canonical per-route ordering maps and implementation details, use:

- [SEO Section Ordering Reference](./section-ordering-reference.md)
