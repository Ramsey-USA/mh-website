...
- Use the approved MH primary slogan when a slogan is required.
...
| ---------------- | ------------------------------------------------------------------------------- |
| Cadence          | Weekly posts are steady and aligned to the project phase                        |
| Proof quality    | Every public post is backed by actual project evidence                          |
...
- [Brand Messaging Strategy](../branding/strategy/messaging.md)
- [Social Media Branding Parameters](./parameters/social-media-branding-parameters.md)
- [Media Strategy & Photo/Video Roadmap](../media/media-strategy.md)
