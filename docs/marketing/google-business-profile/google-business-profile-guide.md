...
- Progress photos from active projects (with client permission)
...
- **Review insights** → Track views, clicks, calls
...
- [x] Address correct
- [x] Phone number current
- [x] Website URL added
- [x] Business hours updated (7am-4pm M-F)
- [ ] Business description optimized (750 characters)
- [ ] Services listed (all offerings)
...
- Use Google Business app on mobile
...
- [ ] Upload 2-3 new photos (5 min)
- [ ] Check Q&A for new questions (2 min)
...
- [Google Business Profile Documentation](./index.md) - folder entry point for GBP playbooks, templates, and review workflows.
