...
- Current app stack in repo: Next.js 16.2.12, React 19.2.8, Tailwind CSS 4.3.3, TypeScript 6.0.3.
- Runtime and adapter baseline: Node.js 22+, `@opennextjs/cloudflare` 1.20.2, Wrangler 4.114.0.
