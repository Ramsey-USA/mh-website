...
function createPlaceholderImage() {
  ...
  const svg = `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="50%" y="50%" text-anchor="middle" dy=".3em" fill="#6b7280" font-family="mendl-sans-dusk, Mendl Sans Dusk, mendl-sans-dusk, Mendl Sans Dusk, Roboto, sans-serif" font-size="16">
