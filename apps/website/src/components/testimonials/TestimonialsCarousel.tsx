    ...
    <div className={`relative mx-auto max-w-5xl ${className}`}>
      ...
      <div className="relative bg-white dark:bg-gray-800 shadow-2xl rounded-3xl p-8 sm:p-12 lg:p-16 flex flex-col justify-between">
        ...
        <div className="flex items-center space-x-4 border-t border-gray-200 dark:border-gray-700 pt-6">
          {/* Avatar */}
          <div className="shrink-0 flex justify-center items-center bg-linear-to-br from-brand-primary to-brand-secondary shadow-lg p-3 rounded-2xl w-16 h-16 sm:w-20 sm:h-20">
