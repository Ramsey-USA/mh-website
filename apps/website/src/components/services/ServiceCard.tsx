          ...
          <div className="relative flex flex-col grow">
            ...
            >
              ...
              >
                ...
                />
                <span
                  className={`font-subheading font-bold text-sm font-heading uppercase tracking-wider text-gray-700 dark:text-gray-200 group-hover:text-brand-primary dark:group-hover:text-brand-primary-light transition-colors ${transitionDuration.normal}`}
                >
