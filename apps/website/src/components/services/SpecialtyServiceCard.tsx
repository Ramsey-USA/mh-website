    ...
    <div className="group h-full">
      ...
      >
        <CardHeader className="shrink-0 pb-4 p-4 sm:p-5 lg:p-6">
          ...
          <div
            className={`font-subheading mt-3 inline-flex items-center ${cornerRadius.full} border border-brand-secondary/30 bg-brand-secondary/10 px-3 py-1 text-xs font-semibold font-heading uppercase tracking-wide text-brand-secondary dark:border-brand-secondary/40 dark:bg-brand-secondary/15`}
          >
