    ...
    >
      <FadeInWhenVisible>
        <div className="mx-auto mb-8 grid max-w-4xl gap-3 sm:grid-cols-3">
          ...
          >
            <p className="font-heading text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">
              Service Hubs
            </p>
                  ...
                  .map((location) => {
                    ...
                    const content = (
                      <>
                        ...
                        {link && (
                          <span className="font-heading ml-auto inline-flex items-center text-xs font-semibold uppercase tracking-wide text-brand-secondary opacity-0 transition-opacity group-hover/item:opacity-100">
                            Explore
                            <MaterialIcon
                              icon="arrow_forward"
                              size="sm"
