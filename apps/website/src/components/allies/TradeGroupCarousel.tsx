...
export function TradeGroupCarousel({
  ...
  const logoPanel = (
    ...
    >
      ...
      {/* Role badge */}
      <div className="font-subheading inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full border text-xs font-bold uppercase tracking-wider bg-brand-primary/10 dark:bg-brand-primary/20 text-brand-primary dark:text-brand-primary-light border-brand-primary/30">
        <MaterialIcon
          icon="verified"
          size="sm"
  ...
  const infoPanel = (
    <div className="flex flex-col gap-4 p-6 sm:p-8 flex-1 min-w-0 border-t md:border-t-0 md:border-l border-gray-100 dark:border-gray-700">
      ...
      {vendor.portfolio.length > 0 && (
        <div>
          <h4 className="font-subheading text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5">
            Our Work Together
          </h4>
