    ...
    >
      <div className="mb-8 sm:mb-10 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 sm:p-6">
        <div className="space-y-5">
          ...
          <div>
            <p className="font-subheading mb-3 text-xs sm:text-sm font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300">
                  ...
                  <div className="mt-auto pt-4 sm:pt-5">
                    ...
                    >
                      ...
                      <div className="relative flex items-center justify-center gap-2 py-3 sm:py-3.5 px-4">
                        ...
                        />
                        <span className="font-subheading font-bold text-xs sm:text-sm uppercase tracking-wider text-gray-700 dark:text-gray-200 group-hover:text-brand-primary dark:group-hover:text-brand-primary-light transition-colors duration-300">
                          {t.clickForDetails}
                        </span>
                        <MaterialIcon
                          icon="arrow_forward"
