...
export const enhancedSEO = {
  ...
  defaultDescription:
    "MH Construction delivers project-stakeholder-focused planning and execution across Washington, Oregon, and Idaho from Tri-Cities headquarters, including commercial, tenant improvement, municipal, agricultural and winery, and light industrial work.",
  ...
  defaultKeywords: [
    ...
    "public-sector construction delivery",
...
export function generateEnhancedOrganizationSchema() {
  return {
    ...
    memberOf: [
      ...
      {
        "@type": "Organization",
        name: "Associated General Contractors - Inland Northwest Chapter",
        url: "https://business.nwagc.org/memberdirectory/Details/mh-construction-3229535",
      },
    ],
    potentialAction: [
      {
...
export function generateConstructionFAQSchema() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "MH Construction provides commercial, industrial, and government project delivery, including general contracting, project management, front-end scope planning, tenant improvements, light industrial builds, design-build, and facility renovations.",
    },
    {
