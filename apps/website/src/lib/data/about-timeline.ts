...
export const aboutTimelineSteps: TimelineStep[] = [
  ...
  {
    num: 3,
    icon: CONTENT_ICONS.family_restroom,
  ...
  {
    num: 7,
    icon: CONTENT_ICONS.celebration,
  ...
  {
    num: 10,
    icon: CONTENT_ICONS.trending_up,
