...
const legacyManuals: DocumentEntry[] = [
  ...
  },
  {
    ...
    subtitle: "MH Construction Strategy and Messaging Execution",
    description:
      "Guide for campaign planning, content operations, and brand-safe execution aligned to MH Construction service delivery and trust standards.",
    category: "manual",
    icon: "campaign",
    revisionYear: 2026,
    revisionNumber: "1.0",
  ...
  },
  {
    ...
    subtitle: "MH Construction Opportunity and Scope Alignment",
    description:
      "Guide for opportunity qualification, estimate development, and relationship handoff coordination with leadership and delivery teams.",
    category: "manual",
    icon: "request_quote",
    revisionYear: 2026,
    revisionNumber: "1.0",
