...
const legacyManuals: DocumentEntry[] = [
  {
    ...
    description: `MH Construction's written MISH Safety & Health Program (Safety Manual) with ${SAFETY_PROGRAM_TOTAL_SECTIONS} sections (00-${SAFETY_PROGRAM_LAST_SECTION}), aligned with OSHA 29 CFR 1926, AGC CSEA expectations, and applicable WISHA/L&I (WA), OAR (OR), and IDAPA (ID) requirements. Legacy AGC APP references are retained in historical source material for continuity. Covers injury prevention, emergency response, PPE, fall protection, hazard communication, and OSHA-required construction safety standards.`,
    category: "manual",
  ...
  },
  {
    ...
    subtitle: "MH Construction Project Marketing Operations",
    description:
      "V2 guide for project marketing operations, content planning, proof standards, and relationship continuity aligned to MH Construction delivery and trust standards.",
    category: "manual",
    icon: "campaign",
    revisionYear: 2026,
    revisionNumber: "2.0",
    revisionDate: "7/30/2026",
    totalSections: 9,
    pdfPath: "/docs/marketing/marketing-strategy-guide-toc.pdf",
    r2Key: "docs/marketing/marketing-strategy-guide-toc.pdf",
    tags: ["marketing", "strategy", "brand", "execution", "proof"],
  },
  {
    id: "sales-estimating-guide",
    title: "Sales and Estimating Guide",
    subtitle: "MH Construction Ground Truth Estimating",
    description:
      "V2 guide for opportunity qualification, Ground Truth estimating, approval controls, and mission-ready handoff coordination with leadership and delivery teams.",
    category: "manual",
    icon: "request_quote",
    revisionYear: 2026,
    revisionNumber: "2.0",
    ...
    tags: ["sales", "estimating", "handoff", "delivery", "preconstruction"],
  },
];
