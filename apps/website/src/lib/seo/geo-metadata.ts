...
const PAGEHUB_COMMERCIAL_KEYWORDS = [
  ...
  "construction management",
  "construction-focused project planning",
...
const PAGEHUB_CANONICAL_PHRASES: Record<string, string> = {
  ...
  "general contractor pasco, wa": "general contractor Pasco, WA",
  "commercial construction services": "New Construction Services",
  "commercial construction": "new construction",
  "construction management": "construction management",
  "construction project management": "construction management",
  "project management": "construction management",
  "tenant improvements": "tenant improvements and interior buildouts",
  "tenant improvement": "tenant improvements and interior buildouts",
  preconstruction: "preconstruction planning",
  "pre-construction": "preconstruction planning",
  closeout: "handoff",
  turnover: "handoff",
