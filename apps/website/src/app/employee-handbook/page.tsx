    ...
    <>
      ...
      <section className="bg-linear-to-br from-brand-primary-darker via-brand-primary-dark to-brand-primary px-4 py-14 sm:px-6">
        <div className="mx-auto max-w-5xl text-white">
          <div className="font-subheading inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-1 text-xs font-bold uppercase tracking-wider text-brand-secondary">
            <MaterialIcon
          ...
          <p className="font-subheading mt-2 text-xs font-semibold uppercase tracking-wider text-brand-secondary/90">
            {MH_SLOGANS.primary}
          </p>
      ...
      <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
        <div className="grid gap-4 sm:grid-cols-3 mb-10">
          ...
          <div className="rounded-2xl border border-brand-secondary/20 bg-brand-secondary/5 p-5">
            <p className="font-subheading text-xs font-bold uppercase tracking-wider text-brand-secondary">
              Handbook Forms
            </p>
            <p className="mt-2 text-3xl font-black text-gray-900 dark:text-white">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-800">
            <p className="font-subheading text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
              Published PDF
            </p>
            <p className="mt-2 text-3xl font-black text-gray-900 dark:text-white">
              {totalPages}
