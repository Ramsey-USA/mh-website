...
export default function VeteranLedCompliancePage() {
  return (
    <main className="bg-white dark:bg-gray-950 min-h-screen">
      <section className="hero-section border-b border-gray-200 bg-linear-to-br from-gray-900 via-brand-primary to-gray-900 px-4 py-14 text-white sm:px-6 lg:px-8">
