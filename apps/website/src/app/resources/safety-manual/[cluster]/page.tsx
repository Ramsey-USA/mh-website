      ...
      <main className="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[14rem_1fr]">
        ...
        >
          <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <p className="font-subheading mb-2 text-xs font-bold uppercase tracking-wider text-brand-primary dark:text-brand-secondary">
              Jump to section
            </p>
            ...
            return (
              ...
              >
                ...
                <footer className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-brand-primary/10 pt-4">
                  <p className="font-subheading inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-amber-700 dark:text-amber-300">
