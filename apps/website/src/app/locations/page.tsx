...
export const metadata: Metadata = withGeoMetadata({
  ...
  keywords: [
    ...
    "regional new construction coverage",
    ...
    "tenant improvement regional contractor",
  ],
  alternates: {
  ...
  twitter: {
    ...
    title: `${formatDualPageName(PAGE_TERMINOLOGY.locations.seoName, PAGE_TERMINOLOGY.locations.mhBrandName)} | MH Construction`,
    description:
      "Regional service area profiles with project proof and construction-focused delivery context across WA, OR, and ID.",
    creator: "@mhc_gc",
