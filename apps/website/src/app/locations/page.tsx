...
export const metadata: Metadata = {
  ...
  description:
    "Explore MH Construction service areas across Washington, Oregon, and Idaho with local market coverage, project proof, and disciplined delivery context.",
  alternates: {
...
const locationsSchema = {
  ...
  description:
    "Service area index for MH Construction locations across Washington, Oregon, and Idaho.",
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {locationList.map((location) => (
                <article
                  key={location.slug}
                  className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition-transform hover:-translate-y-1 dark:border-gray-800 dark:bg-gray-900"
                >
