  ...
  return (
    ...
    >
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          All construction and consulting services provided by MH Construction,
          Inc. are subject to separate written agreements. These Terms of
          Service govern your use of our website but do not constitute a
          contract for construction services.
        </p>
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          Project estimates and consultations provided through this website are
          preliminary and non-binding until formalized in a written contract
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          The materials on MH Construction's website are provided on an 'as is'
          basis. MH Construction makes no warranties, expressed or implied, and
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          In no event shall MH Construction, Inc. or its suppliers be liable for
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          current. We may make changes to the materials contained on our website
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          MH Construction may revise these Terms of Service at any time without
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          with the laws of the State of Washington, and you irrevocably submit
