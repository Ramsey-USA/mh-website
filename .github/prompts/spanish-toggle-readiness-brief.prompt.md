...
description: "Use when: running a full English/Spanish localization readiness sweep before merge or release, including the unified global header system."
argument-hint: "Describe scope: locale wiring, global-header controls, toggle components, translated routes, metadata labels, and messages files."
...
1. Identify all localization surfaces in scope (locale utilities, request config, global-header controls, language toggle controls, translated labels, and messages files).
