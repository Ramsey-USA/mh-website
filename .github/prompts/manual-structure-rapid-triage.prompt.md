...
description: "Use when: running a fast manual structure/WBS compliance triage on changed files for PR go/no-go decisions."
...
4. Check WBS numbering integrity where numbering logic/content changed.
5. Check generator consistency regressions introduced in touched render paths.
