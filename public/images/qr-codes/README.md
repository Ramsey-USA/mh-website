...
- **Error:** ENOENT: no such file or directory, unlink '/workspaces/mh-website/public/images/qr-codes/temp-qr-projects-color.png'
...
- **File:** `qr-projects-bw.png`
- **URL:** https://www.mhc-gc.com/projects
- **Error:** ENOENT: no such file or directory, unlink '/workspaces/mh-website/public/images/qr-codes/temp-qr-projects-bw.png'
...
- **Name:** `veterans`
- **File:** `qr-veterans-color.png`
- **URL:** https://www.mhc-gc.com/veterans

### ✅ Veteran-Owned Construction

- **Name:** `veterans`
- **File:** `qr-veterans-bw.png`
- **URL:** https://www.mhc-gc.com/veterans
