...
import { generateProjectStructuredData, generateBreadcrumbStructuredData, StructuredData } from '../../../components/seo/seo-meta'
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-semibold text-gray-700 mb-2">Project Not Found</h1>
          <p className="text-gray-500 mb-6">The project you&apos;re looking for doesn&apos;t exist or has been moved.</p>
          <Link href="/portfolio">
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-6 py-4">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <Link href="/portfolio" className="text-gray-500 hover:text-brand-primary">Portfolio</Link>
            <span className="text-gray-400">/</span>
            <span className="text-brand-primary font-medium">{project.title}</span>
          </nav>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            {/* Image Caption */}
            {activeImage?.caption && (
              <p className="text-sm text-gray-600 italic">{activeImage.caption}</p>
            )}
          </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              {project.details.squareFootage && (
                <div>
                  ...
                  <p className="text-lg">📏 {project.details.squareFootage.toLocaleString()} sq ft</p>
                </div>
              )}
            ...
            <Card className="bg-gradient-to-r from-brand-primary to-blue-600 text-white">
              <CardContent className="p-8">
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <div>
                    <p className="font-semibold text-lg">{project.clientTestimonial.clientName}</p>
                    {project.clientTestimonial.clientTitle && (
                      <p className="text-blue-100">{project.clientTestimonial.clientTitle}</p>
                    )}
                  </div>
                </div>
              </CardContent>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-semibold mb-6">Explore More Projects</h3>
          <Link href="/portfolio">
