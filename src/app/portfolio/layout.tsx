...
export const metadata = generateSEOMetadata({
  ...
  description:
    "Explore MH Construction's impressive portfolio of residential, commercial, and industrial projects throughout the Pacific Northwest. See our quality craftsmanship and expertise.",
  keywords: [
