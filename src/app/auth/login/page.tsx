        ...
        <div className="text-center">
          <div className="mx-auto h-16 w-16 bg-brand-primary rounded-full flex items-center justify-center mb-4">
            <svg className="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-4m-5 0H9m11 0v-5a2 2 0 00-2-2H7a2 2 0 00-2 2v5m14 0v2a1 1 0 01-1 1h-2a1 1 0 01-1-1v-1a1 1 0 00-1-1H7a1 1 0 00-1 1v1a1 1 0 01-1 1H3a1 1 0 01-1-1v-2m14 0V9a2 2 0 00-2-2H9a2 2 0 00-2 2v10.01M12 16h.01" />
            </svg>
          </div>
        ...
        <Card className="bg-veteran-blue/5 border-veteran-blue/20">
          <CardContent className="p-4">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="font-semibold text-veteran-blue">Veteran-Owned Business</h3>
                <p className="text-sm text-text-secondary mt-1">
                  Proudly serving our community with military precision and dedication.
                </p>
              </div>
            </div>
          </CardContent>
