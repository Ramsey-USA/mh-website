...
export const metadata: Metadata = {
  ...
  description:
    "Connect with MH Construction for expert concrete, carpentry, and general contracting services in Pasco, WA. Call (509) 308-6489 or visit us at 3111 N. Capital Ave. Building for the Client, NOT the Dollar.",
  keywords: [
