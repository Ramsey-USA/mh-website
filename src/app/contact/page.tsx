              ...
              <div className="flex flex-wrap justify-center items-center gap-4 mb-8">
                {quickContact.map((contact, index) => (
                  <a
                    ...
                    className="inline-flex items-center gap-3 px-6 py-4 rounded-xl font-semibold transition-all duration-200 hover:scale-105 shadow-lg bg-gradient-to-r from-brand-primary to-brand-primary-dark hover:from-brand-primary-dark hover:to-brand-primary text-white border-2 border-white/20 hover:border-white/40"
                  >
