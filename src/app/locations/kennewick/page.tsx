...
export default function KennewickLocationPage() {
  ...
  const kennewickSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "@id": `${enhancedSEO.siteUrl}/locations/kennewick#localbusiness`,
    name: "MH Construction - Kennewick",
    description:
      "Veteran-owned general contractor serving Kennewick, Washington with commercial, industrial, and government construction services.",
    url: `${enhancedSEO.siteUrl}/locations/kennewick`,
  ...
  return (
    <>
      <StructuredData data={kennewickSchema} />
      <StructuredData
        data={generateBreadcrumbSchema(breadcrumbPatterns.locationKennewick)}
      />
      ...
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center space-y-6 sm:space-y-8">
              ...
              <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 leading-relaxed font-light">
                Veteran-owned construction excellence serving Kennewick with
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="text-center mb-12 sm:mb-16">
                ...
                <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed font-light mt-6">
                  ...
                  industrial, and government projects throughout Kennewick and
                  the Tri-Cities area.
                </p>
              </div>
        ...
        {/* Why Choose MH Construction in Kennewick */}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3">
                      Local Kennewick Expertise
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                      Based in nearby Pasco, we've been serving Kennewick and
                      the Tri-Cities area since 2010. We understand local
                    ...
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      construction excellence in Kennewick.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
              <h2 className="font-black text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight tracking-tighter">
                ...
                <span className="block text-brand-secondary mt-2">
                  Kennewick Construction Project?
                </span>
              </h2>
