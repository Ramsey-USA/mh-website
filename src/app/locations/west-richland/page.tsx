...
export default function WestRichlandLocationPage() {
  ...
  const westRichlandSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "@id": `${enhancedSEO.siteUrl}/locations/west-richland#localbusiness`,
    name: "MH Construction - West Richland",
    description:
      "Veteran-owned general contractor serving West Richland, Washington with commercial, industrial, and government construction services.",
    url: `${enhancedSEO.siteUrl}/locations/west-richland`,
  ...
  return (
    <>
      <StructuredData data={westRichlandSchema} />
      <StructuredData
      ...
      <main className="min-h-screen">
            ...
            <div className="max-w-5xl mx-auto text-center space-y-6 sm:space-y-8">
              ...
              <div className="flex items-center justify-center gap-2 text-brand-secondary">
                ...
                <span className="text-lg sm:text-xl font-semibold">
                  Serving West Richland, Washington
                </span>
              </div>
              ...
              <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 leading-relaxed font-light">
                Veteran-owned construction excellence serving West Richland with
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="text-center mb-12 sm:mb-16">
                ...
                <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed font-light mt-6">
                  ...
                  industrial, and government projects throughout West Richland
        ...
        {/* Why Choose MH Construction in West Richland */}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3">
                      Local West Richland Expertise
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                      Based in nearby Pasco, we've been serving West Richland
                      and the Tri-Cities area since 2010. We understand local
                      building codes, permitting processes, and the unique
                      construction challenges of Eastern Washington.
                    </p>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                      With over 650 completed projects throughout Benton County
                      and the Tri-Cities, we're your trusted local partner for
                      construction excellence in West Richland.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
              <h2 className="font-black text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight tracking-tighter">
                ...
                <span className="block text-brand-secondary mt-2">
                  West Richland Construction Project?
                </span>
              </h2>
