...
export default function RichlandLocationPage() {
  // Generate location-specific structured data
  const richlandSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "@id": `${enhancedSEO.siteUrl}/locations/richland#localbusiness`,
    name: "MH Construction - Richland",
    description:
      "Veteran-owned general contractor serving Richland, Washington with commercial, industrial, and government construction services.",
    url: `${enhancedSEO.siteUrl}/locations/richland`,
  ...
  return (
    <>
      <StructuredData data={richlandSchema} />
      <StructuredData
        data={generateBreadcrumbSchema(breadcrumbPatterns.locationRichland)}
      />
      ...
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center space-y-6 sm:space-y-8">
              ...
              <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 leading-relaxed font-light">
                Veteran-owned construction excellence serving Richland with
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="text-center mb-12 sm:mb-16">
                ...
                <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed font-light mt-6">
                  ...
                  industrial, and government projects throughout Richland and
                  the Tri-Cities area.
                </p>
              </div>
        ...
        {/* Why Choose MH Construction in Richland */}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3">
                      Local Richland Expertise
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                      Based in nearby Pasco, we've been serving Richland and the
                    ...
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      construction excellence in Richland.
                    </p>
                  </div>
                </div>
              </div>
