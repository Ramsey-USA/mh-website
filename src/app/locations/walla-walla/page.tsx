...
export default function WallaWallaLocationPage() {
  ...
  const wallaWallaSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "@id": `${enhancedSEO.siteUrl}/locations/walla-walla#localbusiness`,
    name: "MH Construction - Walla Walla",
    description:
      "Veteran-owned general contractor serving Walla Walla, Washington with commercial, industrial, and government construction services.",
    url: `${enhancedSEO.siteUrl}/locations/walla-walla`,
  ...
  return (
    <>
      <StructuredData data={wallaWallaSchema} />
      <StructuredData
      ...
      <main className="min-h-screen">
            ...
            <div className="max-w-5xl mx-auto text-center space-y-6 sm:space-y-8">
              ...
              <div className="flex items-center justify-center gap-2 text-brand-secondary">
                ...
                <span className="text-lg sm:text-xl font-semibold">
                  Serving Walla Walla, Washington
                </span>
              </div>
              ...
              <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 leading-relaxed font-light">
                Veteran-owned construction excellence serving Walla Walla with
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="text-center mb-12 sm:mb-16">
                ...
                <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed font-light mt-6">
                  ...
                  industrial, and government projects throughout Walla Walla and
                  Eastern Washington.
                </p>
              </div>
        ...
        {/* Why Choose MH Construction in Walla Walla */}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3">
                      Local Walla Walla Expertise
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                      Serving Walla Walla and Walla Walla County since 2010, we
                      understand the unique construction needs of this historic
                      community. From vineyard facilities to downtown
                      renovations, we bring local knowledge and veteran-owned
                      reliability.
                    </p>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                      With over 650 completed projects throughout Eastern
                      Washington, we're your trusted partner for construction
                      excellence in Walla Walla.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
              <h2 className="font-black text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight tracking-tighter">
                ...
                <span className="block text-brand-secondary mt-2">
                  Walla Walla Construction Project?
                </span>
              </h2>
