  ...
  const consultationTypes = [
    {
      ...
      price: 'Free',
      description:
        'Comprehensive project discussion, site evaluation planning, and initial budget assessment',
      features: [
    ...
    },
    {
      ...
      price: '$150',
      description:
        'In-depth design planning with 3D visualization and detailed material selection',
      features: [
    ...
    },
    {
      ...
      price: '$75',
      description:
        'Engineering assessment, permit requirements, and technical feasibility review',
      features: [
    ...
    },
    {
      ...
      price: 'Free',
      description:
        'Comprehensive review of AI-generated estimate with detailed cost breakdown',
      features: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-100 max-w-4xl mx-auto">
              ...
              Choose from free initial consultations to detailed design
              sessions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                variant="primary"
                size="lg"
                className="bg-transparent border-2 border-white hover:bg-white hover:text-brand-primary"
              >
                View Our Team
              </Button>
            </div>
              ...
              >
                <CardHeader>
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="text-right">
                      <div
                        className={`text-lg font-tactic-bold ${consultation.price === 'Free' ? 'text-green-600' : 'text-brand-primary'}`}
                      >
                        {consultation.price}
                      </div>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <Button
                      variant={
                        consultation.price === 'Free' ? 'primary' : 'secondary'
                      }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our experienced team brings military precision and decades of
              construction expertise to every consultation and project.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-100 max-w-3xl mx-auto">
              Our military-precision approach ensures every consultation
              delivers maximum value and actionable insights for your
            ...
            {[
              {
                ...
                description:
                  'Military-trained professionals with decades of construction experience',
              },
              {
                icon: '📋',
                title: 'Detailed Planning',
                description:
                  'Comprehensive project assessment with actionable next steps',
              },
              {
                icon: '💰',
                title: 'Cost Transparency',
                description:
                  'Honest pricing with no hidden fees or surprise costs',
              },
              {
                icon: '⚡',
                title: 'Quick Response',
                description:
                  'Same-day confirmation and 24-hour follow-up guaranteed',
              },
            ].map((benefit, index) => (
              <div key={index} className="text-center">
                <div className="text-4xl mb-4">{benefit.icon}</div>
                <h3 className="text-xl font-tactic-bold mb-3">
                  {benefit.title}
                </h3>
