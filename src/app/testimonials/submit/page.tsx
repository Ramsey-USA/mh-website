...
export const metadata = generateSEOMetadata({
  ...
  description: 'Share your experience with MH Construction. Submit a testimonial about your construction project and help others learn about our quality services.',
  keywords: [
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Help others discover the quality and professionalism of MH Construction 
              by sharing your project experience with us.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
                ...
                <p className="text-blue-100 text-sm">
                  Your experience helps future clients make informed decisions about their construction projects.
                </p>
              </div>
              
              <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
                <Award className="h-8 w-8 text-white mx-auto mb-3" />
                <h3 className="font-semibold text-white mb-2">Showcase Quality</h3>
                <p className="text-blue-100 text-sm">
                  Your testimonial showcases the quality craftsmanship and professional service we provide.
                </p>
              </div>
              ...
              <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
                ...
                <p className="text-blue-100 text-sm">
                  Authentic reviews build trust and confidence in our construction services and expertise.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <div className="bg-white rounded-lg shadow-md p-8 mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">How to Submit Your Testimonial</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Photos & Submit</h3>
                  <p className="text-sm text-gray-600">
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <Star className="h-4 w-4 text-yellow-500 mt-0.5 flex-shrink-0" />
                    <span>Describe the communication and project management</span>
                  </li>
                </ul>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <Star className="h-4 w-4 text-yellow-500 mt-0.5 flex-shrink-0" />
                    <span>Share how the project met or exceeded expectations</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Star className="h-4 w-4 text-yellow-500 mt-0.5 flex-shrink-0" />
                    <span>Include details about timeline and budget adherence</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Star className="h-4 w-4 text-yellow-500 mt-0.5 flex-shrink-0" />
      ...
      <section className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            See why our clients consistently rate us 5 stars. Get started with a free consultation 
            and experience the MH Construction difference for yourself.
          </p>
