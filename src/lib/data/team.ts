...
export const teamMembers: TeamMember[] = [
  ...
  // Project Management & Estimating
  {
    ...
    bio: "Makayla Holstein, daughter of MH Construction founder Mike Holstein, is a highly-skilled Project Manager who excels at navigating complex project timelines and coordinating all project phases to ensure on-time delivery. Her expertise in communication and problem-solving keeps projects on track and clients informed.",
