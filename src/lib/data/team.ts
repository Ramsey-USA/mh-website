...
export const teamMembers: TeamMember[] = [
  // Executive Leadership
  {
    ...
    bio: "Jeremy Thamert, a U.S. military veteran, became owner of MH Construction in January 2025 after serving as General Manager for 2 years. He brings veteran-owned values of discipline, integrity, and excellence to every project. Jeremy's leadership emphasizes honest communication, transparent pricing, and building lasting partnerships with Client Partners. His military background ensures precision and thoroughness in every aspect of the business, from initial consultation to project completion.",
    slug: "jeremy-thamert",
    active: true,
  },
  {
  ...
  },
  {
    ...
    bio: "As Vice President, Arnold is the key to client partner relationships and strategic operations. He specializes in high-level relationship building and ensures that every project runs smoothly from start to finish. His focus is on personalized service and exceptional quality, guaranteeing client partner satisfaction.",
    slug: "arnold-garcia",
    active: true,
  },
  ...
  // Project Management & Estimating
  {
    ...
    bio: "Ben is a dedicated Project Manager with a focus on project efficiency and budget management. He is an expert in overseeing all aspects of a build, from initial planning to final close-out, ensuring every detail aligns with the client partner's vision and project goals.",
    slug: "ben-woodall",
    active: true,
  },
  {
