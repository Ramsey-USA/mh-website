...
export const mockTestimonials: ClientTestimonial[] = [
  {
    ...
    images: {
      ...
      after: ['/images/testimonials/thompson-after-1.jpg', '/images/testimonials/thompson-after-2.jpg'],
      client: '/images/testimonials/thompson-family.jpg'
    },
    projectDetails: {
      duration: '3.5 months',
      challenges: ['Challenging soil conditions', 'Weather delays during winter'],
      highlights: ['Completed ahead of schedule', 'Under budget delivery', 'Energy-efficient design', 'Custom millwork']
    },
    contactPermission: true,
    tags: ['new construction', 'family home', 'energy efficient', 'custom design'],
    source: 'website',
    responseFromCompany: 'Thank you Jennifer and Mike! It was a pleasure working with you both. We\'re thrilled that you love your new home and appreciate your trust in our veteran team.'
  },
  {
    id: 'testimonial-002',
    ...
    featured: true,
    images: {
      before: ['/images/testimonials/chen-before-1.jpg', '/images/testimonials/chen-before-2.jpg'],
      after: ['/images/testimonials/chen-after-1.jpg', '/images/testimonials/chen-after-2.jpg'],
      client: '/images/testimonials/chen-couple.jpg'
    },
    projectDetails: {
      duration: '7 weeks',
      highlights: ['Custom cabinetry', 'Quartz countertops', 'Modern fixtures', 'Increased home value']
    },
    contactPermission: true,
    tags: ['renovation', 'kitchen', 'bathroom', 'custom cabinetry'],
    source: 'website',
    responseFromCompany: 'Thank you Robert and Lisa! Your kitchen and bathroom transformations turned out beautifully. We appreciate your patience during the renovation process.'
  },
  {
    id: 'testimonial-003',
    ...
    images: {
      ...
      after: ['/images/testimonials/techflow-after-1.jpg', '/images/testimonials/techflow-after-2.jpg']
    },
    projectDetails: {
      duration: '5 weeks',
      challenges: ['Working around occupied business operations', 'Tight timeline'],
      highlights: ['Modern design', 'Minimal business disruption', 'Ahead of schedule completion']
    },
    contactPermission: true,
    tags: ['commercial', 'office renovation', 'modern design'],
    source: 'email',
    responseFromCompany: 'Thank you TechFlow Solutions! We\'re glad your team loves the new workspace. It was a pleasure working with you on this transformation.'
  },
  {
    id: 'testimonial-004',
    ...
    rating: 5,
    testimonialText: 'When a storm damaged our roof and siding, MH Construction responded immediately. They had a team out the same day for emergency repairs and completed the full restoration quickly and professionally. As a fellow veteran, I appreciated their prompt service and quality work during a stressful time.',
    projectValue: '$35,000',
    ...
    projectDetails: {
      duration: '1 week',
      highlights: ['Same-day emergency response', 'Insurance coordination', 'Quality restoration']
    },
    contactPermission: true,
    tags: ['emergency repair', 'storm damage', 'veteran customer'],
    source: 'phone',
    responseFromCompany: 'Thank you for your service, David! We\'re honored to help a fellow veteran and glad we could restore your home quickly.'
  },
  {
    id: 'testimonial-005',
    ...
    rating: 4,
    testimonialText: 'MH Construction did a great job on our home addition and deck project. The work quality is excellent and the team was professional throughout. The project took a bit longer than expected due to permit delays, but they kept us informed and the final result is beautiful.',
    ...
    projectDetails: {
      ...
      highlights: ['Quality craftsmanship', 'Excellent communication', 'Beautiful final result']
    },
  ...
  },
  {
    ...
    rating: 5,
    testimonialText: 'We couldn\'t be happier with our finished basement! MH Construction turned our unused basement into a beautiful family recreation space. The attention to detail, from the flooring to the built-in entertainment center, exceeded our expectations. Highly recommend!',
    projectValue: '$65,000',
    ...
    images: {
      ...
      after: ['/images/testimonials/wilson-after-1.jpg', '/images/testimonials/wilson-after-2.jpg']
    },
    projectDetails: {
      duration: '6 weeks',
      highlights: ['Custom built-ins', 'Quality flooring', 'Entertainment center', 'Family space transformation']
    },
    contactPermission: true,
...
export const getReviewStats = (testimonials: ClientTestimonial[]): ReviewStats => {
  const approvedTestimonials = testimonials.filter(t => t.status === 'approved' || t.status === 'featured')
