    ...
    >
      ...
      <div className="relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <SectionHeader
          icon="timeline"
          iconVariant="bronze"
          subtitle="Company Evolution"
          title="From Founding Father to Veteran Excellence"
          description="15 years of proven trust, now enhanced with operational discipline—where family values meet mission-focused execution. Mike Holstein's partnership philosophy combined with Jeremy Thamert's veteran leadership creates unmatched construction excellence."
        />
