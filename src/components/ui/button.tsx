  ...
  'inline-flex justify-center items-center disabled:opacity-50 border-2 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 font-medium transition-all hover:-translate-y-0.5 active:translate-y-0 duration-300 disabled:pointer-events-none',
  {
    variants: {
      variant: {
        ...
        primary:
          'border-brand-primary bg-white dark:bg-gray-900 text-brand-primary dark:text-brand-primary-light hover:bg-brand-primary hover:text-white hover:border-brand-primary-dark focus:ring-brand-primary shadow-[0_4px_16px_rgba(56,104,81,0.2)] hover:shadow-[0_8px_25px_rgba(56,104,81,0.35)]',

        // MH Construction Secondary - Leather Tan
        secondary:
          'border-brand-secondary bg-white dark:bg-gray-900 text-brand-secondary dark:text-brand-secondary-light hover:bg-brand-secondary hover:text-white hover:border-brand-secondary-dark focus:ring-brand-secondary shadow-[0_4px_16px_rgba(189,146,100,0.2)] hover:shadow-[0_8px_25px_rgba(189,146,100,0.35)]',

        // MH Construction Outline
        outline:
          'border-brand-primary bg-transparent text-brand-primary dark:text-brand-primary-light hover:bg-brand-primary/5 dark:hover:bg-brand-primary-light/10 focus:ring-brand-primary/50',
        ...
        link: 'border-transparent bg-transparent text-brand-primary dark:text-brand-primary-light underline-offset-4 hover:underline hover:text-brand-primary-dark dark:hover:text-brand-primary focus:ring-brand-primary/50 hover:translate-y-0',
      },
      size: {
