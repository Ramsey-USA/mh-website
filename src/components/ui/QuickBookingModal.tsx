  ...
  return (
    <div className="z-[60] fixed inset-0 flex justify-center items-center animate-modal-backdrop">
      ...
      <div className="z-10 relative mx-4 w-full max-w-3xl max-h-[95vh] overflow-y-auto animate-modal-slide">
        <Card className="bg-gray-800 shadow-2xl border-0 ring-1 ring-black/10 animate-pulse-glow">
          <CardHeader className="relative bg-gradient-to-r from-gray-700 via-gray-600 to-gray-700 p-8 overflow-hidden text-white">
            ...
            <div className="z-10 relative flex justify-between items-start">
              <div className="flex-1">
                <CardTitle className="flex items-center mb-3 font-bold text-3xl">
                  ...
                  />
                  <div>
                    <div>Quick Quote Booking</div>
                    <div className="mt-1 font-normal text-white/90 text-lg">
                      Get your free consultation scheduled in under 2 minutes
                    </div>
                  </div>
                </CardTitle>
          ...
          <CardContent className="bg-gray-800 p-8 text-white">
            {step === 1 && (
              <div className="space-y-8">
                ...
                <div className="flex justify-center items-center space-x-4 mb-6">
                  ...
                  <div className="bg-gray-600 w-12 h-0.5" />
                  <div className="flex items-center">
                    <div className="flex justify-center items-center bg-gray-600 rounded-full w-8 h-8 font-bold text-gray-400 text-sm">
                      2
                    </div>
                      ...
                      <button
                        ...
                        className={`group relative p-4 border-2 rounded-xl text-center transition-all duration-300 hover:scale-105 animate-in slide-in-from-bottom ${
                          selectedDate === day.date
                            ...
                            : 'hover:bg-brand-primary/20 hover:border-brand-primary/50 border-gray-600 hover:shadow-md bg-gray-700 text-gray-200'
                        }`}
                  ...
                  <div className="slide-in-from-bottom pt-6 border-gray-600 border-t animate-in duration-500">
                    ...
                    <div className="flex gap-4">
                      <Button
                        onClick={() => setStep(2)}
                        size="lg"
                        className="flex-1 bg-brand-primary hover:bg-brand-primary-dark shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
                      >
                  ...
                  <div className="space-y-6">
                    <div className="gap-4 grid md:grid-cols-2">
                      <div className="space-y-2">
                        <label className="flex items-center font-semibold text-gray-200 text-sm">
                          <MaterialIcon
                            icon="person"
                            size="sm"
                            className="mr-2 text-brand-primary"
                    ...
                    <div className="gap-4 grid grid-cols-1 md:grid-cols-3 mt-8">
                      <div className="bg-gray-700 p-4 border border-gray-600 rounded-xl text-center">
                        <MaterialIcon
                          icon="schedule"
                          size="lg"
                      ...
                      <div className="bg-gray-700 p-4 border border-gray-600 rounded-xl text-center">
                        ...
                        <div className="text-gray-300 text-xs">30+ Years</div>
                      </div>
                    </div>
                  </div>
                </div>

                <div className="flex gap-4 pt-6 border-gray-600 border-t">
                  <Button
                    variant="outline"
                    onClick={() => setStep(1)}
                    className="hover:bg-gray-700 border-2 border-gray-500 text-gray-300 hover:text-white transition-all duration-300"
                  >
                  ...
                  <Button
                    ...
                    className="flex-1 bg-gradient-to-r from-brand-primary hover:from-brand-primary-dark to-brand-primary-dark hover:to-brand-primary disabled:opacity-50 shadow-lg hover:shadow-xl hover:scale-105 disabled:hover:scale-100 transition-all duration-300 disabled:cursor-not-allowed btn-glow"
                  >
