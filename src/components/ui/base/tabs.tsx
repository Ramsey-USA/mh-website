...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "mt-2 focus-visible:outline-none focus-visible:ring-brand-primary focus-visible:ring-2 ring-offset-white focus-visible:ring-offset-2 dark:ring-offset-gray-800",
      className,
    )}
    {...props}
  />
