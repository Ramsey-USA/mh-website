...
export default function PWAInstall({ onInstall, onDismiss, className = '' }: PWAInstallProps) {
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg shadow-xl max-w-sm w-full p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Install MH Construction</h3>
  ...
  if (showPrompt && (isInstallable || isIOS)) {
    return (
      <div className={`fixed bottom-0 left-0 right-0 bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg z-40 ${className}`}>
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={isIOS ? handleIOSInstallInstructions : handleInstallClick}
    ...
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600">
            App-like experience with smooth animations and native device features
          </p>
        </div>
      </div>
    </div>
