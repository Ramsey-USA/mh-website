    ...
    <section className="video-hero-container">
      ...
      <div className="video-hero-content">
        <div className="max-w-5xl px-4 text-center sm:px-6 lg:px-8">
          {/* Company Badge */}
          <div className="mb-6 inline-flex items-center gap-3 rounded-full bg-emerald-700/80 px-5 py-2.5 backdrop-blur-sm shadow-lg">
            <AmericanFlag size="md" animated={true} />
