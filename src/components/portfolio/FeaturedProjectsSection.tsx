...
import { HammerIcon, CheckIcon, StarIcon, BoltIcon, CalendarIcon } from '../icons/SharpDuotoneIcons'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-24 scroll-reveal">
          ...
          <div className="inline-flex items-center px-6 py-3 mb-8 bg-brand-primary/10 dark:bg-brand-primary/20 rounded-full">
            ...
            <span className="ml-3 text-sm font-bold text-brand-primary uppercase tracking-wide">Featured Excellence</span>
          </div>
          ...
          <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed mb-12" style={{ color: 'var(--color-text-secondary)' }}>
            Discover our exceptional work and see why clients trust MH Construction with their most important projects. 
            Each project represents our commitment to <span className="text-brand-primary font-semibold">military precision</span> and 
            <span className="text-brand-secondary font-semibold"> veteran excellence</span>.
          </p>
        ...
        <div className="projects-grid-enhanced">
          {filteredProjects.map((project, index) => (
            ...
            >
              <Link href={`/portfolio/${project.seoMetadata.slug}`} className="block h-full">
                <div className="project-card-inner">
                  ...
                  <div className="project-content-enhanced">
                    <h3 className="project-title-enhanced">
                      {project.title}
                    </h3>
                    ...
                    <div className="project-meta-enhanced">
                      ...
                      {project.details.completionDate && (
                        <div className="project-completion-enhanced">
                          <CheckIcon size="xs" primaryColor="var(--brand-secondary)" />
                          <span>Completed {new Date(project.details.completionDate).getFullYear()}</span>
                        </div>
                      )}
                    </div>
                  </div>
            ...
            <div className="portfolio-cta-content">
              ...
              <div className="relative z-10">
                ...
                <div className="inline-flex items-center px-4 py-2 mb-6 bg-brand-primary/15 rounded-full">
                  ...
                  <span className="ml-2 text-sm font-bold text-brand-primary uppercase tracking-wide">Complete Portfolio</span>
                </div>
                ...
                <p className="portfolio-cta-description">
                  Browse through our extensive collection of residential, commercial, and specialty projects. 
                  Each project showcases our dedication to <span className="text-brand-primary font-semibold">military precision</span> and 
                  <span className="text-brand-secondary font-semibold">veteran craftsmanship</span> with cutting-edge technology.
                </p>
                ...
                <div className="portfolio-cta-buttons">
                  <Link href="/portfolio" className="portfolio-cta-btn primary">
                    ...
                    <span className="relative z-10 ml-2">View All Projects</span>
                  </Link>
                  <Link href="/contact" className="portfolio-cta-btn secondary">
                    <BoltIcon size="sm" primaryColor="currentColor" />
                    <span className="relative z-10 ml-2">Start Your Project</span>
                  </Link>
                </div>
                ...
                <div className="portfolio-trust-indicators">
                  {[
                    ...
                    <div key={index} className="trust-indicator">
                      <item.icon size="sm" primaryColor="var(--brand-primary)" />
                      <span>{item.text}</span>
                    </div>
                  ))}
                </div>
