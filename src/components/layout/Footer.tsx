              ...
              <div className="space-y-2 text-gray-300">
                <p className="flex items-center">
                  ...
                  <a
                    ...
                    className="ml-2 hover:text-red-400 transition-colors duration-300 rounded-md px-1 py-0.5"
                  >
                    (509) 308-6489
                  </a>
                </p>
                ...
                <div className="mt-4 p-3 bg-gray-800/50 dark:bg-gray-900/50 rounded-lg border border-red-500/20">
                  <p className="text-sm text-gray-400">
                    <strong className="text-red-400">Emergency 24/7:</strong>{' '}
                    (509) 308-6489
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
              ...
              <div className="flex items-center space-x-4 text-sm">
                ...
                <Link
                  href="/dashboard"
                  className="footer-legal-link footer-legal-link-dashboard"
                >
                  Team Dashboard
                </Link>
              </div>
