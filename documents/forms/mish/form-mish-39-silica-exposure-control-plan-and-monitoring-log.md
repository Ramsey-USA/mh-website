# MISH 39 - Silica Exposure Control Plan and Monitoring Log

## Fillable Schema

- Manifest entry: `MISH 39`
- Fillable schema: `documents/forms/mish/form-mish-39-silica-exposure-control-plan-and-monitoring-log.json`
- Manual alignment: MISH 39
